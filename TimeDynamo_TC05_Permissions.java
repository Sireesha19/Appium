...
public class TimeDynamo_TC05_Permissions extends TimeDynamo_BaseUrl {
	...
	public void requests(HashMap<String, String>hash) throws InterruptedException {
		extentTest=extentReport.createTest("Adding Permission Request");
		TimeDynamo_LoginElements obj1=new TimeDynamo_LoginElements(driver);
		obj1.permission(hash.get("Employee1"),hash.get("Employee2"),hash.get("Message"),hash.get("EndDate"));
